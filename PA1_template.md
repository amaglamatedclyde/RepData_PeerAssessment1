...
<h3> Introduction</h3>
In this report we will demonstrate the principles of reproducible analyses by providing an integrated document that combines source code and code output.  
